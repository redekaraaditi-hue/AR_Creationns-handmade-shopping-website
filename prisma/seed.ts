  ...
  const products = [
    {
      ...
      description: "Handcrafted traditional bridal choker set paired with matching jhumkas.",
      inStock: true,
    },
    {
      ...
      description: "Vibrant artisanal meenakari earrings crafted with natural beads.",
      inStock: true,
    },
    {
      ...
      tag: "New Arrival",
      image: "https://images.unsplash.com/photo-1611591475878-578f244199aa?q=80&w=800&auto=format&fit=crop",
      description: "Delicate handcrafted floral motif bangles for festive occasions.",
      inStock: true,
    },
    {
      ...
      description: "Authentic 21-pan saaj necklace celebrating rich traditional heritage.",
      inStock: true,
    },
  ];
